 ...
 * The source Renderscript file: C:\\Users\\debasish\\Documents\\Received Files\\SimpleFractal-master\\SimpleFractal-master\\src\\com\\hiqes\\SimpleFractal\\mand_gen.rs
 */

package com.hiqes.SimpleFractal.mand_gen;
 ...
 * @hide
 */
public class ScriptC_mand_gen extends ScriptC {
    private static final String __rs_resource_name = "mand_gen";
    // Constructor
    public  ScriptC_mand_gen(RenderScript rs) {
        this(rs,
    ...
    public  ScriptC_mand_gen(RenderScript rs, Resources resources, int id) {
    ...
    public void bind_palette(Allocation v) {
        mExportVar_palette = v;
        if (v == null) bindAllocation(null, mExportVarIdx_palette);
        else bindAllocation(v, mExportVarIdx_palette);
    }
